...
class BTS7960_PRO {
  public:
    ...
    void runNoCollectorMotor(int time_d=1) { // beta version - (M1 + M2 + M3)/2
      // https://www.asutpp.ru/chto-takoe-beskollektornyj-dvigatel-postoyannogo-toka-i-ego-princip-raboty.html
      // digitalWrite(MOTOR_PWM_PIN[0],1);
      // digitalWrite(MOTOR_DIR_1[0],  1);
      // digitalWrite(MOTOR_PWM_PIN[1],1);
      // digitalWrite(MOTOR_DIR_1[0],  0);
      // digitalWrite(MOTOR_PWM_PIN[2],0);
      // digitalWrite(MOTOR_DIR_1[2],  0);
      // delay(time_d);
      // digitalWrite(MOTOR_PWM_PIN[0],0);
      // digitalWrite(MOTOR_DIR_1[0],  0);
      // digitalWrite(MOTOR_PWM_PIN[1],1);
      // digitalWrite(MOTOR_DIR_1[0],  0);
      // digitalWrite(MOTOR_PWM_PIN[2],1);
      // digitalWrite(MOTOR_DIR_1[2],  1);
      // delay(time_d);
      // digitalWrite(MOTOR_PWM_PIN[0],1);
      // digitalWrite(MOTOR_DIR_1[0],  0);
      // digitalWrite(MOTOR_PWM_PIN[1],0);
      // digitalWrite(MOTOR_DIR_1[0],  0);
      // digitalWrite(MOTOR_PWM_PIN[2],1);
      // digitalWrite(MOTOR_DIR_1[2],  1);
      // delay(time_d);
      ...
      // digitalWrite(MOTOR_DIR_1[2],  0);
      // delay(time_d);
      BTS7960_PRO::run(1,100,false);
      BTS7960_PRO::run(2,-100,false);
      BTS7960_PRO::run(3,0);
      delay(time_d);
      BTS7960_PRO::run(1,0,false);
      BTS7960_PRO::run(2,-100,false);
      BTS7960_PRO::run(3,100);
      delay(time_d);
      BTS7960_PRO::run(1,-100,false);
      BTS7960_PRO::run(2,0,false);
      BTS7960_PRO::run(3,100);
      delay(time_d);
      BTS7960_PRO::run(1,-100,false);
      BTS7960_PRO::run(2,100,false);
